    ...
    <div className="bg-secondary shadow-sm">
      <div className="w-[80%] m-auto flex gap-4 items-center justify-between py-3">
        <Link className="hidden md:block" href="/">
          <Image src={logo} width={80} height={80} alt="logo" className="cursor-pointer" />
        </Link>
        ...
        <ul className="hidden md:flex gap-6 items-center">
          <Link href="/dashboard">
            <li
              className={`hover:text-primary hover:font-bold transition-all cursor-pointer ${
                path === "/dashboard" ? "text-primary font-bold" : "text-foreground"
              }`}
            >
              Dashboard
            </li>
          ...
          <Link href="/dashboard/question">
            <li
              className={`hover:text-primary hover:font-bold transition-all cursor-pointer ${
                path === "/dashboard/question" ? "text-primary font-bold" : "text-foreground"
              }`}
            >
              Questions
            </li>
          ...
          <Link href="/interview-prep">
            <li
              className={`hover:text-primary hover:font-bold transition-all cursor-pointer ${
                path === "/interview-prep" ? "text-primary font-bold" : "text-foreground"
              }`}
            >
              Interview Prep
            </li>
          ...
          <Link href="/dashboard/howit">
            <li
              className={`hover:text-primary hover:font-bold transition-all cursor-pointer ${
                path === "/dashboard/howit" ? "text-primary font-bold" : "text-foreground"
              }`}
            >
              How it works?
            </li>
          ...
          <div className="px-5 py-3">
            <ul className="space-y-3">
              <Link href="/dashboard" onClick={() => setIsOpen(false)}>
                <li
                  className={`hover:text-primary hover:font-bold transition-all cursor-pointer py-2 ${
                    path === "/dashboard" ? "text-primary font-bold" : "text-foreground"
                  }`}
                >
                  Dashboard
