...
const sampleMediaContent: MediaContentCollection = {
  video: {
    src: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', // Example YouTube video, replace with actual
    poster:
      'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?q=80&w=1280&auto=format&fit=crop',
    background:
